...
export default function Post({ name, navigation }) {
    ...
    <View style={styles.container}>
        ...
        <TouchableOpacity
          onPress={() =>
            navigation.navigate('PhotoView', {
              photo: 'https://media.istockphoto.com/photos/football-goal-picture-id504268081',
            })
          }>
          <Image
            source={{
      ...
      <View style={styles.bottomContainer}>
        ...
        <View style={styles.commentContainer}>
          <Text style={[styles.commentName, { paddingLeft: 10 }]}>
            {authData.Player.firstName} {authData.Player.lastName}
          </Text>
